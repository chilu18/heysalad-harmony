...
const Approvals = () => {
  const approvalStats = [
    ...
    { label: 'Approved Today', value: '8', icon: CheckCircle, color: 'bg-green-500' },
    { label: 'Rejected', value: '2', icon: XCircle, color: 'bg-red-500' },
    { label: 'Total This Month', value: '156', icon: FileText, color: 'bg-blue-500' },
  ];
  ...
  const pendingApprovals = [
    ...
    },
    {
      ...
      details: '8 hours overtime - Weekend shift',
      date: 'Oct 28, 2024',
      priority: 'urgent',
      icon: Clock,
    },
    ...
    },
    {
      ...
      employee: 'Michael Becker',
      department: 'Warehouse',
      details: 'Forklift certification renewal',
      date: 'Nov 15, 2024',
      priority: 'normal',
      icon: FileText,
    },
  ...
  const recentActivity = [
    { type: 'Approved', request: 'Overtime - Sarah Wagner', time: '2 hours ago', status: 'approved' },
    { type: 'Approved', request: 'Leave Request - John Doe', time: '3 hours ago', status: 'approved' },
    { type: 'Rejected', request: 'Purchase - Office Supplies', time: '5 hours ago', status: 'rejected' },
  ];
